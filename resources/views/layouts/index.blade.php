                            ...
                            <div class="job-listing-details">
                                ...
                                <div class="job-listing-description">
                                    ...
                                    <div class="job-listing-footer">
                                        <ul>
                                            <li><i class="icon-material-outline-business"></i> {{App\User::find($serv->id_user)->name}} <div class="verified-badge" title="Verified Employer" data-tippy-placement="top"></div></li>
    ...
    <div class="sign-in-form">
        ...
        <div class="popup-tabs-container">
            ...
            <div class="popup-tab-content" id="login">
                ...
                <button> <a href="{{ url('/auth/redirect/facebook') }}" class="icon-brand-facebook"></i> Log In via facebook</a></button>

                </div>

                <div class="social-login-separator"><span>or</span></div>
                <div class="social-login-buttons">
                <button> <a href="{{ url('/login/linkedin') }}" class="icon-brand-linkedin"></i> Log In via linkedin</a></button>
            ...
            <div class="popup-tab-content" id="register">
                ...
                <div class="social-login-separator"><span>or</span></div>
                <div class="social-login-buttons">
                    <a href="{{ url('/auth/redirect/facebook') }}" class="facebook-login ripple-effect"><i class="icon-brand-facebook-f"></i> Register via Facebook</a>
                </div>

                <div class="social-login-separator"><span>or</span></div>
                <div class="social-login-buttons">
                    <a href="{{ url('/login/linkedin') }}" class="icon-brand-linkedin"></i> Register via linkedin</a>
